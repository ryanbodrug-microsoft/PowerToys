...
const static wchar_t* MODULE_NAME = L"example_ui";
...
class example_ui : public PowertoyModuleIface
{
private:
    // The PowerToy state.
...
void example_ui::init_settings()
{
    try
    {
        // Load and parse the settings file for this PowerToy.
        PowerToysSettings::PowerToyValues settings =
            PowerToysSettings::PowerToyValues::load_from_settings_file(example_ui::get_name());
